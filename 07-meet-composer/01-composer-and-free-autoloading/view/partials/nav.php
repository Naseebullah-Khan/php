<nav class="bg-gray-800/50">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" aria-current="page" class="<?= urlIs("/") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
                                                                ?> rounded-md px-3 py-2 text-sm font-medium">Home</a>
                        <a href="/about" class="<?= urlIs("/about") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
                                                ?> rounded-md px-3 py-2 text-sm font-medium">About</a>
                        <?php if ($_SESSION["user"] ?? false): ?>
                            <a href="/notes" class="<?= urlIs("/notes") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
                                                    ?> rounded-md px-3 py-2 text-sm font-medium">Notes</a>
                        <?php endif ?>
                        <a href="/contact" class="<?= urlIs("/contact") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <el-dropdown class="relative ml-3">
                        ...
                        <?php else: ?>
                            <a href="/register" class="<?= urlIs("/register") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
                                                        ?> rounded-md px-3 py-2 text-sm font-medium">Register</a>
                            <a href="/login" class="<?= urlIs("/login") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
                    ...
                    <?php if ($_SESSION["user"] ?? false): ?>
                        <div class="ml-3">
                            <form action="/session" method="POST">
                                ...
                                <button type="submit"
                                    class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Logout</button>
                            </form>
                        </div>
                    <?php endif ?>
                </div>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
            <a href="/" aria-current="page" class="<?= urlIs("/") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
                                                    ?> block rounded-md px-3 py-2 text-base font-medium">Home</a>
            <a href="/about" class="<?= urlIs("/about") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
                                    ?> block rounded-md px-3 py-2 text-base font-medium">About</a>
            <?php if ($_SESSION["user"] ?? false): ?>
                <a href="/notes" class="<?= urlIs("/notes") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
                                        ?> block rounded-md px-3 py-2 text-base font-medium">Notes</a>
            <?php endif ?>
            <a href="/contact" class="<?= urlIs("/contact") ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"
